                            ...
                            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                    <table class="min-w-full leading-normal">
                                        <thead>
                                        <tr>
                                            <th v-for="field in hospital_fields"
                                                scope="col"
                                        ...
                                        <tbody>
                                        <tr v-for="hospital in hospitals.data">
    ...
    export default {
        ...
        methods: {
            myOnBlur(selectedHospital) {
                let theHospital = this.hospitals.data.find(hospital => hospital.id == selectedHospital.id);
        ...
        mounted() {
            ...
            console.log(this.hospitals.data)
